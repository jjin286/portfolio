  ...
  return (
    ...
    >
      ...
      >
        {items.map((items) => (
            <li
              className="flex justify-center items-center w-[70vw] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-800 p-5 md:p-16 md:w-[15vw]"
              style={{
